...
function mainfunction()
{
	...
	$.getJSON("http://api.openweathermap.org/data/2.5/weather?q=" + l + "&units=si&appid=6ba76e81b921b55d5f15b37ba2a2e089",function(data)
	{
		console.log(data);
...
function forecast()
{
	...
	$.getJSON("http://api.openweathermap.org/data/2.5/forecast?q=" + l + "&appid=6ba76e81b921b55d5f15b37ba2a2e089",function(forecast)
	{
